...
function renderItems(){
    ...
    for (const [idx, item] of Object.entries(items)) {
        ...
        contaner.style.marginBottom = "10px";
...
function addItem(){
    ...
    if(!value){
        alert("You cannot add an empty item to youre Todo List");
        return;
    }
    items.push(value);
    renderItems();
...
document.addEventListener("DOMContentLoaded", loadeItems)